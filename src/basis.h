...
struct GTOPW_contraction {
    ...
    cdouble operator()(int m, const double &r, const double &theta, const double &phi) const;
...
struct Basis {
    ...
    std::vector<cdouble> operator()(const double &r, const double &theta, const double &phi) const;
